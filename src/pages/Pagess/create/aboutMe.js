            ...
            <div className="parent-aboutMe">
                ...
                <div className="box-container-aboutMe">
                    <div className="box-aboutMe">
                        <div>
                            <div className="location-aboutMe">
                                {t("aboutMe.where")}
                            </div>
                            <div className="select-location-aboutMe">
                                <select
                                    value={location}
                                    onChange={(e) =>
                                        handleSelectChange(e, setLocation)
                                    }
                                    required
                                >
                                    <option></option>
                        ...
                        <div className="select-conatiner-aboutMe">
                            ...
                            <div className="select-location-aboutMe">
                                <select
                                    value={country}
                                    onChange={(e) =>
                                        handleSelectChange(e, setCountry)
                                    }
                                    required
                                >
                                    <option></option>
                            ...
                            <div className="select-date-aboutMe">
                                <div className="option-date-aboutMe">
                                    <select
                                        value={dayDate}
                                        onChange={(e) =>
                                            handleSelectChange(e, setDayDate)
                                        }
                                        required
                                    >
                                        <option></option>
                                ...
                                <div className="option-date-aboutMe">
                                    <select
                                        value={monthDate}
                                        onChange={(e) =>
                                            handleSelectChange(e, setMonthDate)
                                        }
                                        required
                                    >
                                        <option></option>
                                ...
                                <div className="option-date-aboutMe">
                                    <select
                                        value={yearDate}
                                        onChange={(e) =>
                                            handleSelectChange(e, setYearDate)
                                        }
                                        required
                                    >
                                        <option></option>
